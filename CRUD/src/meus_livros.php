<?php include "lib/tabelar_meus_livros.php"; ?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="utf-8">
...
<body>
            ...
            <div id="header-content" class="container-fluid">
                ...
                <section id="header-right-content" class="collapse navbar-collapse">
                    <ul id="header-right-content-list" class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="meus_livros.php" class="link-active d-flex align-items-center">
    ...
    <main class="container py-3">
        ...
        <?php if (isset($_SESSION['MENSAGEM'])) { ?>
            <p class="text-center text-success mb-4 fs-4">Livro alugado com sucesso!</p>
        <?php } ?>
            ...
            <table id="tabela-livros" class="table table-striped border border-2">
                ...
                <tbody>
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <form method="POST" action="script/devolver_livro.php">
                                <input name="devolver-livro" value="<?php echo $linha[0]; ?>" type="hidden">  

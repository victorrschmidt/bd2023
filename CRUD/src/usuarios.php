<?php
    include "lib/tabelar_usuarios.php";
        ...
        <div class="table-responsive">
            <table id="tabela-livros" class="table table-striped border border-2">
                <thead>
                    ...
                    <th scope="col">Livros alugados</th>
                ...
                <tbody>
                    ...
                    <tr valign="middle">
                        ...
                        ?>
                        <td><?php echo $linha[$i]; ?></td>
                        <?php } ?>
                        <td>
                            <form method="GET" action="livros_alugados.php">
                                <input name="livros-alugados" value="<?php echo $linha[0]; ?>" type="hidden">
                                <input name="usuario-livros" value="<?php echo $linha[1]; ?>" type="hidden">   
                        ...
                        <td>
                            <form method="POST" action="script/remover_usuario.php">
                                <input name="remover-usuario" value="<?php echo $linha[0]; ?>" type="hidden">  
